...
@hydra.main(config_path="config/icdm/diagnostics", config_name="smoke_test", version_base=None)
...
if __name__ == "__main__":
    ...
    sys.argv.append(
        "hydra.run.dir=./out/${oc.select:method,method}/${oc.select:dataset.name,dataset}/${now:%Y-%m-%d-%H-%M-%S}"
    )
    main()
